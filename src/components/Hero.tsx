    ...
    <section className="relative overflow-hidden py-10 sm:py-16 lg:py-24">
      ...
      <Container className="relative">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-[1.05fr_0.95fr] gap-10 items-start">
          ...
          <div className="animate-[fadeInUp_0.75s_ease-out_0.1s_backwards] h-full flex flex-col mt-8 lg:mt-0 lg:ml-10">    
              {/* Terminal Window */}
