  ...
  return (
    <Container className="py-20 lg:py-32 relative">
      ...
      <div className="relative z-10 bg-white dark:bg-slate-950 rounded-3xl border border-slate-200 dark:border-slate-800 p-6 sm:p-8 overflow-hidden shadow-xl shadow-slate-200/50 dark:shadow-2xl">
        <div className="absolute inset-0 bg-[url('/img/grid.svg')] opacity-5 dark:opacity-10"></div>
        ...
        <div className="relative flex flex-col lg:flex-row items-start lg:items-center justify-between gap-8">
          <div className="flex items-center gap-4 lg:w-1/4">
            <div className="w-12 h-12 rounded-xl bg-cyan-500/10 dark:bg-cyan-500/20 border border-cyan-500/20 dark:border-cyan-500/30 flex items-center justify-center flex-shrink-0">
