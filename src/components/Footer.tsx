...
export function Footer() {
  ...
  return (
    <footer className="bg-gradient-to-b from-slate-100/70 via-slate-50 to-white dark:from-gray-900 dark:via-gray-950 dark:to-gray-950 text-gray-900 dark:text-white py-8 lg:py-16 overflow-x-hidden">
      <Container>
