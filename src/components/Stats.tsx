      ...
      <Container>
        <div className="text-center mb-16 animate-[fadeInUp_0.6s_ease-out]">
          <SectionTitle
            ...
            align="center"
          />
          <p className="mt-3 text-sm text-gray-600 dark:text-gray-400">{language === "en" ? "Measurable objectives, not vanity metrics." : "Des objectifs mesurables, pas des KPIs détachés de la réalité opérationnelle."}</p>
        </div>
