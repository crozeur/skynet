      ...
      <Container className="py-16 sm:py-20 lg:py-24">
        ...
        <article className="max-w-4xl mx-auto">
          <header className="mb-12">
            ...
            <div className="mb-4">
              <span
                className={`inline-flex items-center px-4 py-2 rounded-full text-sm font-bold text-white bg-gradient-to-r ${pillarColors[post.pillar]} shadow-lg`}
              >
                {post.pillar}
              </span>
            </div>
            ...
            <div className="text-center max-w-2xl mx-auto">
              <h2 className="text-2xl sm:text-3xl font-bold text-gray-900 dark:text-white mb-4">
                {language === "en" 
                  ...
                  : "Télécharger la checklist cybersécurité"}
              </h2>
