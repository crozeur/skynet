<div class="header">
    ...
    <p style="margin-top: 15px; font-size: 10pt; color: #64748b;">
        ...
        <em>Confidentiel - Destinataires autorisés uniquement</em>
    </p>
</div>
...
<div class="financial-summary">
    ...
    <p class="subtext">**8.2/10** - Modèle extrêmement viable avec des risques maîtrisables moyennant mise en œuvre des recommandations.
</p>
</div>
