...
<div class="gray-box" style="background-color:#f0f8ff; border-left-color:#3498db;">
<strong>Introduction pour le lecteur :</strong> Ce chapitre décrit la manière dont nous avons mené notre enquête (l'audit). Pour un lecteur non technique, cela signifie que nous expliquons nos méthodes de travail, les outils utilisés et les règles que nous avons respectées pour obtenir une vue claire et objective de l'état actuel de Skynet Consulting.
</div>
...
<div class="gray-box" style="background-color:#f0f8ff; border-left-color:#3498db;">
<strong>Introduction pour le lecteur :</strong> Ici, nous analysons les fondations techniques de Skynet Consulting (serveurs, bases de données, réseaux). L'objectif est de vérifier si le système est solide face aux pannes ou aux cyberattaques (Cyber-résilience). En termes simples, nous nous assurons que la "maison" Skynet Consulting est construite sur des bases solides et sécurisées.
</div>
...
<div class="gray-box" style="background-color:#f0f8ff; border-left-color:#3498db;">
<strong>Introduction pour le lecteur :</strong> Dans cette partie, nous décortiquons comment Skynet Consulting gagne et dépense son argent (le modèle économique). Nous regardons les coûts liés aux technologies et évaluons si les investissements actuels sont rentables et adaptés pour soutenir la croissance future de l'entreprise.
</div>
