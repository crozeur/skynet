export const metadata = {
  ...
  coverAlt: "Minimalist glass panels and tidy digital file grid, cyan edge lighting, precision laser scan on dark obsidian background",
  coverImage: "https://res.cloudinary.com/dqmdwljit/image/upload/v1771817903/tdrhn2oqutl34lke0wqu.png",
};
