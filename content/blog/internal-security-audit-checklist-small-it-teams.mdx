export const metadata = {
  title: "The Complete Internal Security Audit Checklist for Small IT Teams",
  ...
  coverImage: "https://res.cloudinary.com/dqmdwljit/image/upload/n8ug3cntbsgratedwygx.png",
};
