export const metadata = {
  ...
  coverAlt: "Minimalist grid table of audit rows on dark glass, cyan highlights, with a calibrated ruler and neat document tabs",
  coverImage: "https://res.cloudinary.com/dqmdwljit/image/upload/v1771823745/i49wnudwgfdnpuxxybaf.png",
};
