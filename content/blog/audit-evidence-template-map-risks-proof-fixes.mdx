export const metadata = {
  ...
  coverAlt: "Illuminated glass panels aligned over a precise data grid, icy blue scan beams on a dark obsidian background",
  coverImage: "https://res.cloudinary.com/dqmdwljit/image/upload/v1771817138/rjxa0wgaxvscidpkflph.png",
};
