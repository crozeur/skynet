export const metadata = {
  ...
  coverAlt: "Abstract geometric grid of labeled tiles and checkmarks on dark surface, cyan edge lighting, precise audit structure metaphor",
  coverImage: "https://res.cloudinary.com/dqmdwljit/image/upload/v1771823687/jhbrpteemrmjrlgne2rv.png",
};
