export const metadata = {
  ...
  coverAlt: "Glowing data cubes scanned by neon lasers inside a digital vault, with a geometric padlock and blue code streams",
  coverImage: "https://res.cloudinary.com/dqmdwljit/image/upload/v1771816520/oyqbib2uixsg7s72cflr.png",
};
