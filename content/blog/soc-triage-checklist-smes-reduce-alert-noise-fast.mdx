export const metadata = {
  title: "SOC Triage Checklist: How to Reduce Alert Noise Fast and Effectively",
  ...
  coverAlt: "Analyst-style triage board with stacked alert cards funneling into a single case tile, cyan edge light on dark obsidian desk",
  coverImage: "https://res.cloudinary.com/dqmdwljit/image/upload/dyey666xjsgowoprfama.png",
};
