export const metadata = {
  title: "Top Cloud Misconfigurations to Fix Immediately in Microsoft 365 & AWS",
  ...
  tags: ["SME", "Security", "misconfigurations"],
  coverAlt: "Abstract glass server racks with misaligned panels, cyan light leaking through gaps on a dark obsidian background",
  coverImage: "https://res.cloudinary.com/dqmdwljit/image/upload/orkjlxqmnkukpcakhryv.png",
};
