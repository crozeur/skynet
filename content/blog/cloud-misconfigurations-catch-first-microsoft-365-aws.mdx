export const metadata = {
  ...
  coverAlt: "Dark glass server architecture with soft blue fiber-optic cables and minimalist data platforms on an obsidian backdrop",
  coverImage: "https://res.cloudinary.com/dqmdwljit/image/upload/v1771817886/bj5z8yhp70pbpql6xbdg.png",
};
