export const metadata = {
  ...
  tags: ["SME", "Security", "soc-2", "audit-evidence", "ephemeral-infrastructure", "policy-as-code", "immutable-logs", "evidence", "template"],
  coverAlt: "Abstract glass-like cubes evaporating into clean geometric ledger lines, cyan edge lighting on an obsidian background",
  coverImage: "https://res.cloudinary.com/dqmdwljit/image/upload/v1775422851/bo8eho4wpexiggedqoja.png",
};
