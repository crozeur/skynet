export const metadata = {
  ...
  tags: ["SME", "Security", "cloud", "resilience", "multi-cloud", "network-security", "dns", "foundations"],
  coverAlt: "Abstract glass-like data conduits splitting and reconverging under cyan light, representing multi-cloud egress failover testing",
  coverImage: "https://res.cloudinary.com/dqmdwljit/image/upload/v1774818049/gp4pnsfqt16a9bvisk56.png",
};
