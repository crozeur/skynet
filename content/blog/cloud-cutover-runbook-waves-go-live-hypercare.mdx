export const metadata = {
  title: "The Ultimate Cloud Cutover Runbook: Go-Live & Hypercare Strategies",
  ...
  coverAlt: "Abstract wave-like glass panels stepping forward, cyan/teal edge light on dark obsidian background, runbook checklist nearby",
  coverImage: "https://res.cloudinary.com/dqmdwljit/image/upload/zojb5vphcidxk706o0v2.png",
};
