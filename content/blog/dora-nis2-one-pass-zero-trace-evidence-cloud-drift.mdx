export const metadata = {
  ...
  coverAlt: "Abstract crystalline ledger shards aligned in precise rows, cyan/teal rim light on an obsidian background, photorealistic macro.",
  coverImage: "https://res.cloudinary.com/dqmdwljit/image/upload/v1776027653/pblj1imklwgah9vgzymo.png",
};
