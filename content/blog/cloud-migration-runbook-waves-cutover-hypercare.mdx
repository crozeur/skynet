export const metadata = {
  ...
  coverAlt: "Abstract dark-glass server architecture with blue fiber-optic cables and stacked data platforms under neon edge lighting",
  coverImage: "https://res.cloudinary.com/dqmdwljit/image/upload/v1771817137/eppbmjqalrxspowbka2j.png",
};
