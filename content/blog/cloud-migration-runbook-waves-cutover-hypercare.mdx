export const metadata = {
  ...
  date: "2026-02-22",
  pillar: "CLOUD",
  topic: "Hypercare & Stabilization",
  tags: ["SME", "Security"],
  coverAlt: "3D cloud server cluster with directional arrows showing migration waves, cutover switch, and a stabilizing pulse line",
  coverImage: "https://res.cloudinary.com/dqmdwljit/image/upload/v1771794041/efibyhur0ngtcto2tvvo.png",
};
