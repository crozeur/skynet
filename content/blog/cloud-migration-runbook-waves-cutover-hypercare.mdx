export const metadata = {
  ...
  coverAlt: "Abstract cloud nodes and floating server arrays connected by glowing cyan pathways on a dark navy background with central focal point",
  coverImage: "https://res.cloudinary.com/dqmdwljit/image/upload/v1771816514/xcmyeisnaaunkoiyuogl.png",
};
