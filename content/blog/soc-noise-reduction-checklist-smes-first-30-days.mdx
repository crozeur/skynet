export const metadata = {
  title: "SOC Noise Reduction Checklist: Optimizing Alerts in Your First 30 Days",
  description: "Start by capturing a baseline for 5–7 days:",
  date: "2026-02-09",
  pillar: "SOC",
  topic: "Noise Reduction",
  tags: ["SME", "Security", "triage", "noise-reduction", "checklist"],
  coverAlt: "Minimalist SOC dashboard glass panels filtering a chaotic stream of alert icons into neat stacks, teal light on obsidian",
  coverImage: "https://res.cloudinary.com/dqmdwljit/image/upload/hkx5nteapozyoqp6vzbg.png",
};
