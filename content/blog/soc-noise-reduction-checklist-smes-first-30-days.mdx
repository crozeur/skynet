export const metadata = {
  ...
  coverAlt: "SOC analyst desk with glowing alert stream, checklist clipboard, and network nodes on a dark navy background",
  coverImage: "https://res.cloudinary.com/dqmdwljit/image/upload/v1770867854/zualqiqkvcedeixxoweq.png",
