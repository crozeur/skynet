export const metadata = {
  title: "Hunting Lateral Movement via ENTRA ID Device Code + OAuth Consent Abuse",
  ...
  pillar: "SOC",
  topic: "SOC Setup",
  tags: ["SME", "Security", "Entra ID", "Microsoft Defender", "KQL", "OAuth", "Incident Response", "Device Code", "soc-setup", "operations", "runbook"],
  coverAlt: "Abstract split-token prism with teal light trails over a dark SOC console, representing device code and OAuth consent abuse.",
  coverImage: "https://res.cloudinary.com/dqmdwljit/image/upload/v1775422850/ubxdumqhzsczzjetk2tm.png",
};
