export const metadata = {
  ...
  tags: ["SME", "Security", "SOC 2", "CI/CD", "Change Management", "Terraform", "Audit Evidence", "evidence", "template"],
  coverAlt: "Abstract evidence chain of glass tiles and hashed tags on obsidian surface with cyan edge lighting",
  coverImage: "https://res.cloudinary.com/dqmdwljit/image/upload/v1773608466/ibhc46nkwhezsiqm6tmy.png",
};
