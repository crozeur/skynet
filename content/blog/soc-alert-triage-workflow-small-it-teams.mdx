export const metadata = {
  title: "Designing an Effective SOC Alert Triage Workflow for Small IT Teams",
  description: "Security insights for small and mid-sized businesses",
  date: "2026-01-19",
  pillar: "SOC",
  topic: "Alert Triage",
  tags: ["SME", "Security", "triage", "alerts", "workflow"],
  coverAlt: "Minimalist SOC desk scene with stacked alert cards funneling into one incident ticket, teal accent light on obsidian background",
  coverImage: "https://res.cloudinary.com/dqmdwljit/image/upload/cvbecxqkvfxsixksfypi.png",
};
