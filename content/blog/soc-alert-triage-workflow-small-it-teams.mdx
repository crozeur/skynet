export const metadata = {
  ...
  coverAlt: "Close-up of dark-glass SOC dashboard with subtle red alert dots and teal data map glow on an obsidian background",
  coverImage: "https://res.cloudinary.com/dqmdwljit/image/upload/v1771817979/tjdymcizd768ozogxbpb.png",
};
