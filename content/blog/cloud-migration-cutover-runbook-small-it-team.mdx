export const metadata = {
  title: "Cloud Migration Cutover: A Step-by-Step Runbook for Small IT Teams",
  ...
  coverAlt: "Abstract glass server racks with a precise checklist grid and teal light, suggesting a timed cutover sequence",
  coverImage: "https://res.cloudinary.com/dqmdwljit/image/upload/q1x6lnbvltw8trhxyi94.png",
};
