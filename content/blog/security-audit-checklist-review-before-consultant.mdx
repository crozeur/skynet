export const metadata = {
  ...
  coverAlt: "Cybersecurity checklist on clipboard with laptop and lock icon on dark desk, high-contrast lighting, modern IT audit vibe",
  coverImage: "https://res.cloudinary.com/dqmdwljit/image/upload/v1769768674/ogxkk56ihoi8ypvuqfbo.png",
};
