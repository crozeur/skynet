export const metadata = {
  title: "Pre-Audit Checklist: What to Review Before the Security Consultant Arrives",
  ...
  coverAlt: "Minimalist checklist clipboard beside a neatly stacked set of labeled server drive trays, cyan accent light on dark background",
  coverImage: "https://res.cloudinary.com/dqmdwljit/image/upload/b7e6d5jncblsmerrrtor.png",
};
