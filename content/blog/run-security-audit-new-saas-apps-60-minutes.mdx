export const metadata = {
  title: "Run Security Audit New Saas Apps 60 Minutes",
  ...
  coverAlt: "Glass panels aligned over a dark grid as icy blue scan beams sweep across, conveying a precise SaaS security audit workflow.",
  coverImage: "https://res.cloudinary.com/dqmdwljit/image/upload/v1771817973/rctvlwkwayv8xgyisopi.png",
};
