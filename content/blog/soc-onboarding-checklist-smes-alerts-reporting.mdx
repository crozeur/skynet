export const metadata = {
  ...
  coverAlt: "Abstract 3D SOC scene with floating holographic threat screens, cyan heatmap anomalies, and hexagonal security grid on dark navy",
  coverImage: "https://res.cloudinary.com/dqmdwljit/image/upload/v1771816439/wi6vacjgkjzybzshj1dk.png",
};
