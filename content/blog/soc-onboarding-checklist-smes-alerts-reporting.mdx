export const metadata = {
  ...
  coverAlt: "Dark-glass SOC dashboard close-up with red alert dots and teal topographic data maps on an obsidian background",
  coverImage: "https://res.cloudinary.com/dqmdwljit/image/upload/v1771817136/x372mmmkzkab4iaskgez.png",
};
