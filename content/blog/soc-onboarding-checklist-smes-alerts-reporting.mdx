export const metadata = {
  ...
  coverAlt: "Abstract digital radar waves and glowing network nodes representing security operations center monitoring.",
  coverImage: "https://res.cloudinary.com/dqmdwljit/image/upload/v1771815551/nhcmbtvkrdyvabycxssf.png",
};
