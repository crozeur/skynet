export const metadata = {
  title: "SOC Onboarding Checklist for SMEs: Configuring Alerts and Reporting",
  ...
  pillar: "SOC",
  topic: "Alert Triage",
  tags: ["SME", "Security", "triage", "alerts", "checklist"],
  coverAlt: "Minimalist SOC dashboard on dark obsidian surface with teal light, layered checklist cards and alert ribbons in focus",
  coverImage: "https://res.cloudinary.com/dqmdwljit/image/upload/i9fnsbfkhcbnsszwwady.png",
};
