export const metadata = {
  title: "Audit Evidence Guide: How to Collect, Map, and Track Compliance",
  ...
  tags: ["SME", "Security", "evidence", "template", "guide"],
  coverAlt: "Minimalist grid of labeled document tiles and checkmarks on dark obsidian surface with teal edge lighting",
  coverImage: "https://res.cloudinary.com/dqmdwljit/image/upload/ipbu53k6gol3iqznokzx.png",
};
