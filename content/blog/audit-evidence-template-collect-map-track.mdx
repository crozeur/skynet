export const metadata = {
  ...
  coverAlt: "Evidence register spreadsheet grid with labeled rows, checklist icons, and a magnifying glass highlighting one record",
  coverImage: "https://res.cloudinary.com/dqmdwljit/image/upload/v1770867853/c02sm6cso5y7ttttdmwp.png",
