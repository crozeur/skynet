export const metadata = {
  title: "The Definitive SOC Alerts Triage Playbook for Small IT Teams",
  ...
  coverAlt: "Abstract triage flow tiles and cyan-lit decision funnel over dark dashboard glass on an obsidian background",
  coverImage: "https://res.cloudinary.com/dqmdwljit/image/upload/kolc97e0axedhd1torm9.png",
};
