export const metadata = {
  ...
  pillar: "SOC",
  topic: "SOC Setup",
  tags: ["SME", "Security", "Entra ID", "Token Replay", "CloudTrail", "Microsoft Defender", "OSQuery", "soc-setup", "operations"],
  coverAlt: "Dark SOC dashboard tracing Entra ID token replay events across hybrid cloud environments with teal accent telemetry",
