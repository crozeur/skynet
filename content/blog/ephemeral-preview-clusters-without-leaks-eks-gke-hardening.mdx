export const metadata = {
  ...
  tags: ["SME", "Security", "kubernetes", "eks", "gke", "network-policy", "ephemeral-clusters", "foundations"],
  coverAlt: "EKS and GKE ephemeral cluster hardening against DNS exfiltration and IAM misconfigurations",
