export const metadata = {
  title: "Mastering Cloud Migrations: Essential Steps, Roles, and Hypercare",
  ...
  coverAlt: "Minimalist tech scene with a precise checklist timeline and teal-lit switch lever over dark glass server racks",
  coverImage: "https://res.cloudinary.com/dqmdwljit/image/upload/abwpnketbn9xdnk5bvts.png",
};
