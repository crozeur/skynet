export const metadata = {
  title: "Securing Cloud Storage & IAM: Essential Configurations for SMEs",
  ...
  coverAlt: "Abstract glass storage blocks with misaligned access layers, cyan/teal rim light on dark obsidian background",
  coverImage: "https://res.cloudinary.com/dqmdwljit/image/upload/kvix9i2ahvyqchpdlew9.png",
};
