export const metadata = {
  title: "Cloud Misconfigurations: SME Storage & IAM Basics",
  description: "Practical fixes for common cloud storage and IAM misconfigurations in SMEs: prevent public exposure, enforce least privilege, reduce key risk, and add validation.",
  date: "2026-01-29",
  pillar: "CLOUD",
  topic: "Misconfigurations",
  tags: ["SME", "Security", "misconfigurations", "iam", "storage"],
  coverAlt: "Cloud storage bucket and identity access controls highlighted on a dark cybersecurity dashboard, high-contrast lighting",
  coverImage: "https://res.cloudinary.com/dqmdwljit/image/upload/v1769764809/ykrvsh6ih4o0p2h6nkne.png",
};
