export const metadata = {
  ...
  coverAlt: "SOC analyst triaging security alerts on a dark dashboard with incident timeline and severity indicators",
  coverImage: "https://res.cloudinary.com/dqmdwljit/image/upload/v1769768675/jsptyobldj4fbo3bwl2d.png",
};
