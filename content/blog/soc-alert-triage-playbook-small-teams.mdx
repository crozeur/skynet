export const metadata = {
  title: "SOC Alert Triage Playbook: Streamlining Operations for Small Teams",
  description: "Security insights for small and mid-sized businesses",
  date: "2026-01-29",
  pillar: "SOC",
  topic: "Alert Triage",
  tags: ["SME", "Security", "triage", "alerts", "playbook"],
  coverAlt: "Minimalist SOC dashboard glow over stacked log cards on a dark desk, cyan accent light, abstract triage decision path",
  coverImage: "https://res.cloudinary.com/dqmdwljit/image/upload/t6ft0xymwww1fwrimucp.png",
};
