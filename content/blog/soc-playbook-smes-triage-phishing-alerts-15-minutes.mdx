export const metadata = {
  title: "SOC Playbook: How to Triage Phishing Alerts in Under 15 Minutes",
  ...
  coverAlt: "Minimalist SOC triage timer beside an email header panel, cyan light slicing across dark glass on obsidian background",
  coverImage: "https://res.cloudinary.com/dqmdwljit/image/upload/zedo3hshuzxezwxa94ea.png",
};
